...
import { Users, MessageSquare, TrendingUp, Inbox, Activity, ArrowRight } from "lucide-react";
        ...
        <div className="lg:col-span-2 card-surface p-5">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={chartData}>
              ...
              <Area type="monotone" dataKey="leads" name="Leads" stroke="#7C3AED" fill="url(#colorLeads)" strokeWidth={2} />
